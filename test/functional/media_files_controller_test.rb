...
class MediaFilesControllerTest < ActionController::TestCase
  ...
  test "should create media_file" do
    assert_difference('MediaFile.count') do
      post :create, media_file: { feature: @media_file.feature, ftype: @media_file.ftype, name: @media_file.name, path: @media_file.path }
    end
  ...
  test "should update media_file" do
    put :update, id: @media_file, media_file: { feature: @media_file.feature, ftype: @media_file.ftype, name: @media_file.name, path: @media_file.path }
    assert_redirected_to media_file_path(assigns(:media_file))
  end
